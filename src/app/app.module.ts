...
@NgModule({
    ...
    providers: [ProcessHTTPMsgService, DishService, LeaderService, PromotionService, {provide: 'baseURL', useValue: baseURL}, FavouriteService, PokemonService, CouchbaseService, PlatformService],
    schemas: [
        NO_ERRORS_SCHEMA
    ]
})
